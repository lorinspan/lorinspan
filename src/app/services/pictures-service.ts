...
export const pictures: Picture[] = [
  ...
  new Picture(2,
    ...
    'This image captures my early exploration into studio-like portrait photography, equipped with my newly acquired lighting setup, albeit not perfect. It included a light positioned behind Stefania, an off-camera flash with an umbrella diffuser, and a wireless trigger on the camera.',
    '18th of April, 2024',
    'The Lion Complex',
